...
sudo_users = {SUDO,859213488,1759990986,968613145,1890233810,1885313077}   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝙰𝚂𝙰𝙻𝙸𝚈𝙰₎ •𖣘❩',url="t.me/H1_MA"}},
...
local Text = [[ 
[قناه سورس مون ادخل وتابع الجديد](t.me/V_I_K_I_N_G_1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》', url="t.me/V_I_K_I_N_G_1"}}, 
...
╭𖣘━┅⟞⟦[𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶](http://t.me/V_I_K_I_N_G_1)⟧⟝┉━𖣘╮
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨𖣘• ⁽𝙰𝚂𝙰𝙻𝙸𝚈𝙰₎ •𖣘❩',url="t.me/H1_MA"},{text = '❨𖣘• ⁽𝚃𝙴𝚃𝙾₎ •𖣘❩', url="t.me/e2_c11"}},
{{text = '❨𖣘• ⁽𝚉𝙸𝙺𝙰₎ •𖣘❩',url="t.me/Zika120"},{text = '❨𖣘• ⁽𝙾𝚇𝚈𝙶𝙴𝙽₎ •𖣘❩', url="t.me/Oxy_gen8"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》',url="t.me/V_I_K_I_N_G_1"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/V_I_K_I_N_G_2/84&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝙰𝚂𝙰𝙻𝙸𝚈𝙰₎ •𖣘❩',url="t.me/H1_MA"},{text = ' ❨𖣘• ⁽ᴛ ᴇ ᴛ ᴏ - ᴏғғʟɪɴᴇ₎ •𖣘', url="t.me/e2_c11"}},
{{text = '❨𖣘• ⁽𝚉𝙸𝙺𝙰₎ •𖣘',url="t.me/Zika120"},{text = ' OXTGEN ✰',url="t.me/Oxy_gen8"}}, 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶》 ', url="t.me/V_I_K_I_N_G_1"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/V_I_K_I_N_G_2/84/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'عسليه' or text == 'عسليه مصر' or text == 'مبرمج السورس'  then
local Text = [[
عسليه مبرمج سورس مون للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝙰𝚂𝙰𝙻𝙸𝚈𝙰₎ •𖣘❩',url="t.me/H1_MA"}},
...
if text == "تصميم مون" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,3); 
...
if text == 'العاب مون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
