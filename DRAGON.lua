...
sudo_users = {SUDO,859213488,1770739933,1763213425,189023810,1770739933}   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝙏𝘼𝙒𝘼𝙎𝙐𝙇₎ •𖣘',url="t.me/SAYTRA55"}},
{{text = '《〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠》',url="t.me/uu_regan"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SAYTRA55285BOT&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
•┉ • ┉ • ┉ 《 𝐑𝐄𝐆𝐀𝐍》 ┉ • ┉ • ┉•
 ...
 〠 مسح الجروبات
•┉ • ┉ • ┉ 《𝐑𝐄𝐆𝐀𝐍》 ┉ • ┉ • ┉•
➫ .[🖨┇〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠.](t.me/TW_MOHAMED_BOT)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '〠𝐒𝐎𝐔𝐑𝐒𝐄 𝐑𝐄𝐆𝐀𝐍〠', url="t.me/TW_MOHAMED_BOT"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
