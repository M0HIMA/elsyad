...
sudo_users = {SUDO,859213488,859213488,1762894643,1878146526,859213488,1791666758}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ✰ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐘𝐀𝐃 ✰")  
...
{{text = 'ͲᎳՏ',url="t.me/TW_MOHAMED_BOT"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,' ♢ اصدار سورس الصياد { s: 6.7}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SO_ALSIYAD"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐓𝐖𝐋](t.me/TW_MOHAMED_BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 𝐓𝐖𝐀𝐒𝐎𝐋 ❩ ', url="t.me/TW_MOHAMED_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/HAMO0Op/5897&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ♢ العضو ← ['..result.title_..'](t.me/'..(username or 'SO_ALSIYAD')..')'
status  = '\n ♢ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♢ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_ALSIYAD')..') \n ♢ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ♢ العضو : {["..data.first_name_.."](T.ME/SO_ALSIYAD)}\n ♢ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local Text = [[
المبرمج حمو لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ ✰  𝙼𝙾𝙷𝙰𝙼𝙴𝙳 ✰  ❩ ',url="t.me/H1_MA"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == '♢◁◈══ 𝐒𝐈𝐘𝐀𝐃 ══◈▷ ' then
local Text = [[ 
ᎳᎬᏞᏟΌᎷᎬ ͲΌ ՏΌႮᎡᏟᎬ ᏙᎪΝ
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ ✰ 𝐒𝐎𝐔𝐑𝐂𝐄 ✰  ❩', url="t.me/SO_ALSIYAD"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/F_R_M1/479&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᎠᎬᏙ ', url="t.me/TW_MOHAMED_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/F_R_M1/522&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/F_R_M1/485&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♢ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_ALSIYAD')..') \n ♢ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♢ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_ALSIYAD')..')'
status  = '\n ♢ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♢ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♢ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_ALSIYAD')..')'
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/SO_ALSIYAD)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ♢ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'SO_ALSIYAD')..')'..'\n ♢ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✰ ՏΌႮᎡᏟᎬ ᏙᎪΝ ✰.',url="t.me/SO_ALSIYAD"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SO_ALSIYAD)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[علي فين يوسخ..🙂😹](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[طب انا بحبك يوه..💔🥺](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بحبح اكتر ..🙂❤️](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونا كان مين قالي ميسد ..🙂💔](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[شخصيه انت يعني ..🙂😹](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ قولي بحب الفضايح ..🙂😹](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ اومرني يقلبي ..❤️](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ كان نفسي ابقا محترم شبهك بس مجموعي مجبش ..😹🙂](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ هو مفكرني بني ادم ..😹🙂](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يلا متجيش هنا تاني..😹🙂](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚♥️](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعلمو اي يعني..💔😒](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..💔🥺](t.me/SO_ALSIYAD)') 
return false
end
end
end
...
"  اخويا الفنان اللي رحته حلوه منغير برالصياد😂🕺🏼",
...
{
{text = ' ✰ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐘𝐀𝐃 ✰', url="t.me/SO_ALSIYAD"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
