...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit/AsaliyaEgypt/VIKING/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Ffasit/AsaliyaEgypt/VIKING/main/DRAGON.lua')
...
اتبع الزر إلى تحت 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𖣘• ⁽𝙰𝚂𝙰𝙻𝙸𝚈𝙰₎ •𖣘❩', url="t.me/AsaliyaEgypt"}}, 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨𖣘• ⁽𝙰𝚂𝙰𝙻𝙸𝚈𝙰₎ •𖣘❩',url="t.me/AsaliyaEgypt"},{text = '❨𖣘• ⁽𝚃𝙴𝚃𝙾₎ •𖣘❩', url="t.me/e2_c11"}},
...
local Text = [[
تويتي مطور سورس فايكينج للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit/AsaliyaEgypt/VIKING/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/AsaliyaEgypt/VIKING/main/File_Bot/"..file)
if res == 200 then
