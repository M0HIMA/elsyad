...
sudo_users = {SUDO,859213488,175990986,1770739933,1763213425,188531307}   
...
if tonumber(result.sender_user_id_) == tonumber(175990986) then  
...
if result.id_ == tonumber(175990986) then
...
if tonumber(userid) == tonumber(175990986) then  
send(msg.chat_id_, msg.id_, " 〠 لا تسطيع حظر مالك السورس عام")
return false 
end
